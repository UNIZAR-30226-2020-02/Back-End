...
urlpatterns = [
    ...
    url('get/allsongs', views.GetAllSongs, name='GetAllSongs'), # ^ Creo que ya esta arreglado
    ...
    url('get/alltematics', views.GetAllTematics, name='GetAllTematics'), # *
    ...
    url('get/chapter', views.GetPodcastChapter, name='GetPodcastChapter'), # - Anticuada
    ...
    url('user/get/mostListenedGenres', views.GetMostListenedGenres, name='GetMostListenedSongs'),# *
    ...
    url('user/add/request', views.AddRequest, name='AddRequest'), #Duplicada
